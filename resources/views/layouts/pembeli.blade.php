...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-notif:hover { background: rgba(255,255,255,.12); color: var(--white); }
        .nav-notif svg { width: 17px; height: 17px; }
        ...
        @media (max-width: 768px) {
            .nav-user-info, .nav-user-role { display: none; }
    ...
    <div class="navbar-inner">
        ...
        <div class="nav-links">
            ...
            <a href="{{ route('jadwal.index') }}"
               class="nav-link {{ request()->routeIs('jadwallelang') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('lelang.index') }}"
               class="nav-link {{ request()->routeIs('lelang.*') ? 'active' : '' }}">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="nav-user" tabindex="0">
                <div class="nav-user-btn">
                    ...
                    <div class="nav-user-info">
                        ...
                        <div class="nav-user-role">Pembeli</div>
                    </div>
                ...
                <div class="nav-dropdown">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="dropdown-item danger" style="width:100%;background:none;border:none;text-align:left;cursor:pointer;font-family:inherit;font-size:.82rem;">
                            <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
...
<main class="page-content">
    ...
    {{-- Breadcrumb (optional, yield agar tiap halaman bisa isi) --}}
    ...
    <div class="footer-main">
        ...
        <div>
            ...
            <ul class="footer-links">
                ...
                <li><a href="{{ route('lelang.index') }}">Lelang Aktif</a></li>
                <li><a href="{{ route('jadwallelang') }}">Jadwal Lelang</a></li>
