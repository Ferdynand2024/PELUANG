...
@section('title', 'Laporan Pelelangan Saya')
@section('page-title', 'Laporan Pelelangan Saya')
@section('page-subtitle', 'Laporan pelelangan TPI Anda yang telah dilakukan pembayaran')
@section('content')
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <form action="{{ route('laporan.tpi.index') }}" method="GET" class="row g-3 align-items-end">
                            {{-- Select Tahun --}}
                            <div class="col-md-4">
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                <a href="{{ route('laporan.tpi.export', request()->only(['tahun', 'bulan'])) }}" class="btn btn-success">
